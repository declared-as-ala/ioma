...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="overflow-hidden text-sm transition-all duration-300 ease-out data-open:animate-accordion-down data-closed:animate-accordion-up motion-reduce:duration-0"
      {...props}
    >
      <div
        className={cn(
