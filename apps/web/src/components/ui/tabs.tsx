...
const tabsListVariants = cva(
  "group/tabs-list inline-flex min-h-11 w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none xl:group-data-horizontal/tabs:h-8 xl:group-data-horizontal/tabs:min-h-0",
  {
    variants: {
      variant: {
        default: "bg-muted",
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        "flex-1 text-sm outline-none data-open:animate-in data-open:fade-in-50 duration-200 ease-out motion-reduce:duration-0",
        className,
      )}
      {...props}
    />
