...
describe("AdaptiveConsultationService", () => {
  ...
  const mockObservations: VisionObservations = {
    hydrationAppearance: {
      score: 35,
      level: "Dehydrated",
      note: "Tightness markers detected",
    },
    visiblePores: { score: 65, level: "Visible", note: "T-zone pore dilation" },
    rednessAppearance: { score: 60, level: "Noticeable", note: "Cheek redness" },
    pigmentationAppearance: { score: 40, level: "Even", note: "Minimal spots" },
    fineLinesAppearance: { score: 45, level: "Early Expressions", note: "Fine lines" },
    textureAppearance: { score: 50, level: "Balanced", note: "Smooth surface" },
    radianceAppearance: { score: 45, level: "Balanced", note: "Medium radiance" },
    imperfectionsAppearance: { score: 30, level: "Clear", note: "Low blemishes" },
  };
