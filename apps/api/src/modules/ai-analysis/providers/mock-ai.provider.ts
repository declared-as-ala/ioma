  ...
  async analyze(params: AnalyzeImageParams): Promise<AnalyzeImageResult> {
    ...
    const observations: VisionObservations = {
      hydrationAppearance: {
        ...
        confidence: 0.93,
        explanation: "Surface moisture levels measured across T-zone and cheeks.",
      },
      visiblePores: {
        ...
        confidence: 0.91,
        explanation: "Pore dilation evaluated in central facial zones.",
      },
      rednessAppearance: {
        ...
        confidence: 0.9,
        explanation: "Vascular reactivity and environmental sensitivity index.",
      },
      pigmentationAppearance: {
        score: indicators.spots,
        level: indicators.spots > 50 ? "Localized Spots" : "Even",
        visibleArea: "High cheekbones & temples",
        confidence: 0.88,
        explanation: "Photodamage and uneven tone distribution.",
      },
      fineLinesAppearance: {
        ...
        confidence: 0.92,
        explanation: "Early micro-lines in periorbital and expression areas.",
      },
      textureAppearance: {
        score: indicators.texture,
        level: indicators.texture > 50 ? "Silky" : "Balanced",
        visibleArea: "Cheeks & forehead micro-relief",
        confidence: 0.9,
        explanation: "Epidermal smoothness and micro-relief regularity.",
      },
      radianceAppearance: {
        ...
        confidence: 0.94,
        explanation: "Light scattering capacity and skin vitality.",
      },
      imperfectionsAppearance: {
        score: indicators.imperfections,
        level: indicators.imperfections > 50 ? "Minimal" : "Clear",
        visibleArea: "T-zone & chin",
        confidence: 0.89,
        explanation: "Blemish activity and pore congestion.",
      },
    };
